var JSON_URL = '/kindeditor/images_list';
...
KE.event.ready(function() {
	...
	orderType.options[0] = new Option(lang.fileName, 'data_file_name');
	orderType.options[1] = new Option(lang.fileSize, 'data_file_size');
	orderType.options[2] = new Option(lang.fileType, 'data_content_type');
