module CityHelper
  COUNTRIES = [:afghanistan, :aland_islands, :albania, :algeria, :american_samoa, :andorra, :angola,
          ...
          :kiribati, :korea_democratic_peoples_republic_of, :south_korea, :kuwait, :kyrgyzstan,
  ...
  STATES = {
    ...
    :china => [:beijing, :shanghai, :tianjin, :chongqing, :heilongjiang, :jilin, :liaoning, :inner_mongolia, :hebei,
  ...
  CITIES = {
    ...
    :south_korea => {:south_korea => [:busan, :daejeon, :suwon, :seoul, :daegu,
  ...
  module FormBuilder
    def country_select(id, options = {}, html_options = {})
      @template.country_select @object_name, id, objectify_options(options), html_options
    end
    
    def capital_select(id, options = {}, html_options = {})
      @template.capital_select @object_name, id, objectify_options(options), html_options
    end
    
    def city_select(id, options = {}, html_options = {})
      @template.city_select @object_name, id, objectify_options(options), html_options
    end
    
    def state_select(id, options = {}, html_options = {})
      @template.state_select @object_name, id, objectify_options(options), html_options
    end
  end
...
ActionView::Base.send(:include, CityHelper::FormHelper)
ActionView::Helpers::FormBuilder.send(:include, CityHelper::FormBuilder)
